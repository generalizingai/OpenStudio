...
const translations = {
    en: {
        ...
        'agents.webOnly': 'Available in the web app at openstudio.com',

        // Workflow Studio
        'workflows.title': 'Workflow Studio',
        'workflows.webOnly': 'Available in the web app at openstudio.com',
    ...
    zh: {
        ...
        // Agent Studio
        'agents.title': '智能体工作室',
        'agents.webOnly': '在网页应用 openstudio.com 上可用',

        // Workflow Studio
        'workflows.title': '工作流工作室',
        'workflows.webOnly': '在网页应用 openstudio.com 上可用',
