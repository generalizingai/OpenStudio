...
export function McpCliStudio() {
    ...
    quick.innerHTML = `
        ...
        <div class="grid md:grid-cols-3 gap-4">
            ...
            ${quickStep('3', 'Generate from chat', 'npx skills add generalizingai/Generative-Media-Skills')}
        </div>
    `;
    ...
    cards.appendChild(featureCard({
        ...
        link: 'https://github.com/generalizingai/muapi-cli',
    ...
    cards.appendChild(featureCard({
        ...
        link: 'https://github.com/generalizingai/muapi-mcp-server',
    ...
    cards.appendChild(featureCard({
        ...
        link: 'https://github.com/generalizingai/Generative-Media-Skills',
