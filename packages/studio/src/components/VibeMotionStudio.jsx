...
// ── icons ─────────────────────────────────────────────────────────────────────
const CheckSvg = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#d9ff3f" strokeWidth="4">
    ...
    >
          ...
          <div className="w-full pt-6 flex justify-center animate-fade-in-up">
            <div className="flex flex-col items-center gap-4 py-16">
              <div className="relative w-20 h-20">
                ...
                <div className="absolute inset-2 rounded-full border-2 border-[#d9ff3f]/30 animate-spin" />
            ...
            {history.map((entry, idx) => (
              ...
              >
                ...
                <div className={`absolute top-2 left-2 px-2 py-0.5 rounded-md text-[9px] font-bold uppercase tracking-wider backdrop-blur-sm border ${
                  entry.mode === "edit"
                    ? "bg-[#d9ff3f]/20 text-[#d9ff3f] border-[#d9ff3f]/30"
                ...
                <div className="absolute top-2 right-2 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  {entry.requestId && entry.canEdit !== false ? (
                    <button
                      ...
                      className="p-2 bg-black/60 backdrop-blur-md rounded-full text-white hover:bg-[#d9ff3f] hover:text-black transition-all border border-white/10"
                    >
      ...
      <div className="absolute bottom-4 w-full max-w-[95%] lg:max-w-4xl z-40 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
        <div className="w-full bg-[#0a0a0a]/80 backdrop-blur-3xl rounded-md border border-white/10 p-4 flex flex-col gap-2 shadow-2xl">
          ...
          {/* ── Edit mode banner ── */}
          {editMode && (
            <div className="flex items-center gap-2 px-3 py-1.5 mx-0 bg-[#d9ff3f]/5 border border-[#d9ff3f]/10 rounded text-[10px] text-[#d9ff3f]/80 font-medium tracking-tight">
              ...
              <button
                ...
                className="ml-auto text-[#d9ff3f]/40 hover:text-[#d9ff3f] transition-colors text-base leading-none"
              >×</button>
            </div>
          )}
            ...
            <div className="flex items-center gap-1 bg-white/[0.03] border border-white/[0.05] rounded-full p-0.5 flex-shrink-0">
              <button
                ...
                className={`px-2.5 py-1 rounded-full text-[10px] font-semibold transition-all ${
                  !editMode ? "bg-[#d9ff3f] text-black shadow" : "text-white/40 hover:text-white/70"
                }`}
              >
                Generate
              </button>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 pt-2 border-t border-white/[0.03] relative">
            <div className="flex items-center gap-2 relative flex-wrap pb-1 md:pb-0">
              ...
              <div className="relative">
                ...
                >
                  <div className="w-4 h-4 bg-[#d9ff3f] rounded flex items-center justify-center shadow-lg shadow-[#d9ff3f]/10">
                    <span className="text-[9px] font-bold text-black uppercase">A</span>
                  </div>
                  <span className="text-[11px] font-semibold text-white/70 group-hover:text-[#d9ff3f] transition-colors">
                    {aspectRatio}
                  </span>
              ...
              {editMode && editSources.length > 0 && (
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 bg-[#d9ff3f]/[0.04] hover:bg-[#d9ff3f]/[0.08] rounded-md transition-all border border-[#d9ff3f]/[0.08] group whitespace-nowrap"
                  >
                    <div className="w-4 h-4 bg-[#d9ff3f]/20 rounded flex items-center justify-center border border-[#d9ff3f]/30">
                      <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="#d9ff3f" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
                        <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
                      </svg>
                    </div>
                    <span className="text-xs font-semibold text-[#d9ff3f]/70 group-hover:text-[#d9ff3f] transition-colors max-w-[120px] truncate">
            ...
            <button
              ...
              className="bg-[#d9ff3f] text-black px-4 py-2 rounded-md font-medium text-sm hover:bg-[#e5ff33] hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 w-full sm:w-auto shadow-lg shadow-[#d9ff3f]/10 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {generating ? (
                <>
