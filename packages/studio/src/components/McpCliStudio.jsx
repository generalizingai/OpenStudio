...
muapi image generate "a cyberpunk city" \\
  --model flux-dev`,
    href: 'https://github.com/generalizingai/muapi-cli',
  },
  {
    tag: 'MCP',
  ...
  --header "Authorization: Bearer YOUR_KEY"`,
    href: 'https://github.com/generalizingai/muapi-mcp-server',
  },
  {
    tag: 'Skills',
    ...
    code: `npx skills add generalizingai/Generative-Media-Skills --all`,
    href: 'https://github.com/generalizingai/Generative-Media-Skills',
  },
];
...
const QUICK_STEPS = [
  ...
  { num: '3', title: 'Add the skills', code: 'npx skills add generalizingai/Generative-Media-Skills' },
];
...
function CodeBlock({ children, className = '' }) {
  return (
    <pre
      className={`text-[11.5px] font-mono text-[#d9ff3f] bg-black/50 border border-white/5 rounded-md px-3 py-2 overflow-x-auto whitespace-pre ${className}`}
    >
      {children}
    </pre>
  );
