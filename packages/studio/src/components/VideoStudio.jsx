...
const VideoReadySvg = () => (
  ...
  >
    <polygon points="23 7 16 12 23 17 23 7" />
    <rect x="1" y="5" width="15" height="14" rx="2" ry="2" />
    <polyline points="7 10 10 13 15 8" stroke="#d9ff3f" strokeWidth="2.5" />
  </svg>
);
  ...
  const renderItem = (m, isV2V = false) => (
    ...
    >
      <div className="flex items-center gap-3.5">
        <ModelLogo model={m} size={40} rounded="rounded-xl" />
  ...
  return (
    <div className="flex flex-col h-full max-h-[70vh]">
      ...
      <div className="flex flex-col gap-1.5 overflow-y-auto custom-scrollbar pr-1 pb-2">
        ...
        {/* Video Tools (v2v) now live in their own "Video Tools" module/tab. */}
      </div>
    </div>
  );
}
            ...
            <div className="flex items-center gap-2 relative flex-wrap pb-1 md:pb-0">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="text-xs font-semibold text-white/70 group-hover:text-[#d9ff3f] transition-colors">
                    {selectedModelName}
                  </span>
                  <svg
                    width="8"
              ...
              {showEffect && (
                <div className="relative">
                  ...
                  >
                    ...
                    <span className="text-[11px] font-semibold text-white/70 group-hover:text-[#d9ff3f] transition-colors max-w-[140px] truncate">
