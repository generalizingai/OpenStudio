...
// Inline SVG Icons
// ---------------------------------------------------------------------------
const ScissorsIcon = ({ className = "text-[#d9ff3f]" }) => (
...
const CheckIcon = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#d9ff3f" strokeWidth="3">
                        ...
                        return (
                          <button
                            ...
                            className={`w-full p-4 border rounded-lg text-left transition-all hover:bg-zinc-900/60 flex flex-col gap-2 group/hl ${
                              isActive 
                                ? "border-primary bg-primary/5 shadow-[0_0_12px_rgba(217,255,63,0.03)]" 
        ...
        <div className="w-full bg-[#0a0a0a]/80 backdrop-blur-3xl rounded-md border border-white/10 p-4 flex flex-col gap-2 shadow-2xl">
          ...
          <div className="flex items-center gap-3 px-1">
            ...
            <button
              ...
              className={`w-10 h-10 shrink-0 rounded-full border transition-all flex items-center justify-center relative overflow-hidden ${
                videoUrl 
                  ? "border-[#d9ff3f]/60 bg-[#d9ff3f]/5" 
                  : "bg-white/5 border-white/[0.03] hover:bg-white/10 hover:border-[#d9ff3f]/40"
              } group`}
            >
              {videoUploading ? (
                <div className="flex flex-col items-center justify-center w-full h-full absolute inset-0 bg-black/85 z-20 backdrop-blur-[1px]">
                  <svg className="w-8 h-8 -rotate-90">
                    ...
                    <circle
                      ...
                      className="text-[#d9ff3f] transition-all duration-300"
                    />
                  </svg>
                  <span className="absolute text-[8px] font-black text-[#d9ff3f] leading-none">
                    {videoProgress}%
                  </span>
                </div>
              ) : null}
              ...
              {videoUrl ? (
                <div className="w-full h-full flex items-center justify-center bg-[#d9ff3f]/10 text-[#d9ff3f]">
                ...
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-white/40 group-hover:text-[#d9ff3f] transition-colors">
                  <polygon points="23 7 16 12 23 17 23 7" />
                  <rect x="1" y="5" width="15" height="14" rx="2" ry="2" />
                </svg>
              )}
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 pt-2 border-t border-white/[0.03] relative">
            <div className="flex items-center gap-2 relative flex-wrap pb-1 md:pb-0">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-3 py-2 rounded-md transition-all border whitespace-nowrap text-[11px] font-semibold ${
                  returnCoordinatesOnly 
                    ? "bg-primary/10 border-primary/20 text-[#d9ff3f]" 
            ...
            <button
              ...
              className="bg-[#d9ff3f] text-black px-4 py-2 rounded-md font-medium text-sm hover:bg-[#e5ff33] hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 w-full sm:w-auto shadow-lg shadow-[#d9ff3f]/10 disabled:opacity-50 disabled:cursor-not-allowed uppercase tracking-wider"
            >
              {isGenerating ? (
                <>
