...
- [Open-Pomelli](https://github.com/generalizingai/Open-Pomelli) — Open-source Pomelli alternative — another self-hosted AI assistant
- [open-character-ai](https://github.com/generalizingai/open-character-ai) — Open-source Character.AI alternative with custom AI personas
...
```bash
git clone https://github.com/generalizingai/Open-Poe-AI.git
cd Open-Poe-AI
