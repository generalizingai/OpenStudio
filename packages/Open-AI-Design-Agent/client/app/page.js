      ...
      <main className="flex flex-col gap-6 items-center w-full h-full overflow-y-auto">
        <div className="flex-1 flex flex-col gap-6 sm:gap-8 items-center w-full max-w-7xl pt-6 sm:pt-8 pb-12 px-4 sm:px-8 lg:px-0">
          ...
          <div className="flex items-center gap-6 text-[10px] font-bold uppercase tracking-widest">
            <a href="https://github.com/generalizingai/Open-Lovart" target="_blank" className="flex items-center gap-2 px-4 py-2 bg-bg-card border border-divider rounded-full shadow-sm hover:shadow-md hover:border-primary/30 transition-all text-secondary-text hover:text-primary">
