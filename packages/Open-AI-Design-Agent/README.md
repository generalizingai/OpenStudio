...
> 🤖 **Automate Lovart, Runway, Luma Labs, Krea, Pika & more with AI coding agents:** [Generative-Media-Skills](https://github.com/generalizingai/Generative-Media-Skills) — a library of skills that let agents like **Claude Code**, **Codex**, and other coding assistants drive 200+ image/video models end-to-end (brief → plan → generate → edit → assemble) directly from your terminal. Build automated creative pipelines without touching a UI.

https://github.com/user-attachments/assets/fee3857c-887d-4c27-b3dc-a1fe9ad8f438

### Related projects

> **Open-source Freepik, Krea, Openart alternative — uncensored image & video studio with 200+ models** -> https://github.com/generalizingai/OpenStudio

> **Open-source Weavy, Flora Fauna, Freepik Spaces, Krea Nodes alternative — visual workflow editor** -> https://github.com/generalizingai/Vibe-Workflow

> **Open-source Opus Clip alternative — turn long videos into viral vertical shorts** -> https://github.com/generalizingai/AI-Youtube-Shorts-Generator

> **Open-source multi-modal chatbot and Poe alternative** -> https://github.com/generalizingai/Open-Poe-AI

> **Self-hosted AI voice agent for sales calls and customer support** -> https://github.com/generalizingai/AI-Voice-Agent

<p align="center">
  <a href="https://github.com/generalizingai/awesome-generative-ai-apps">
    <img src="https://img.shields.io/badge/Part%20of-Awesome%20Generative%20AI%20Apps-FFD700?style=for-the-badge&logo=github&logoColor=black" alt="Awesome Generative AI Apps">
  </a>
</p>

> 🎨 **[Explore 50+ more open-source AI apps →](https://github.com/generalizingai/awesome-generative-ai-apps)**
...
- **Workflow Studio** — Visual node-based editor to chain models into repeatable design pipelines (powered by [Vibe Workflow](https://github.com/generalizingai/Vibe-Workflow))
...
> 💡 **Want to add workflows to your own app?** Check out **[Vibe Workflow](https://github.com/generalizingai/Vibe-Workflow)** — the open-source workflow engine powering this feature.
...
git clone https://github.com/generalizingai/Open-AI-Design-Agent.git
...
| **Related Projects** | [OpenStudio](https://github.com/generalizingai/OpenStudio), [Vibe Workflow](https://github.com/generalizingai/Vibe-Workflow) |
