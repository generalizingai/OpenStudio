...
- [OpenStudio](https://github.com/generalizingai/OpenStudio) — Free self-hosted AI media studio — model backend for your pipelines
- [Open-AI-Design-Agent](https://github.com/generalizingai/Open-AI-Design-Agent) — Autonomous AI design agent to embed in your workflows
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/generalizingai/vibe-workflow.git
   cd vibe-workflow
   ```
